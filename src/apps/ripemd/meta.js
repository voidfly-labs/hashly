export default {
  ...
  title: 'RIPEMD-160 Hash Calculator | RIPEMD',
  description:
  ...
  legal: {
    ...
    privacy: {
      ...
      description:
        'Privacy policy for RIPEMD by Voidfly Labs. All hashing runs in your browser — no data is ever transmitted.',
      canonicalUrl: 'https://www.ripemd.com/privacy',
    },
    terms: {
      title: 'Terms of Service | RIPEMD',
      description: 'Terms of service for RIPEMD by Voidfly Labs. Free to use, no account required, provided as-is.',
